            ...
            <div className='pt-4 pr-2'>
                ...
                {open ? (
                    <div
                        ...
                        <Link to={{ pathname: `/profilUser/${user.credentials.username}`, state: { username:user.credentials.username} }} className='block px-4 py-2 text-base text-gray-800 hover:bg-gray-700' role='menuitem'>
                            Ton Profil
                        </Link>
