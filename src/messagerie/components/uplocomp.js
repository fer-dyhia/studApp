...
const Uplocomp = (props) => {
  return (
    <div className="mt-4 w-full">
      <button className="w-full flex justify-between items-center py-3 px-6 cursor-pointer transition duration-700 ease-in-out text-gray-700 hover:text-gray-600 rounded bg-gray-50 hover:bg-gray-200 focus:outline-none">
