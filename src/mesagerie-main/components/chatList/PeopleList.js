...
const PeopleList = () => {
  ...
  return (
    <div>
      ...
      >
        <div class="select-none cursor-pointer bg-gray-50 rounded-md flex flex-1 items-center p-2 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg mb-1">
