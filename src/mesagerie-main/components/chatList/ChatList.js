    ...
    <div className="main__chatlist">
      <span className="mb-3 flex flex-col items-center">
        <div
          ...
          className="flex flex-col items-center mb-2 mt-1 button_avatar rounded-full bg-gray-50"
        >
          <img
        ...
        <p className="text-base w-full text-center font-semibold text-gray-600">
