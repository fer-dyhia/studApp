import { GET_POST, SUBMIT_POST, DELETE_POST, SUBMIT_COMMENT, CLEAN_POSTS, COMMENT_POST,UNLIKE_POST, LOGOUT_USER, UPLOADING_IMAGE_SUCESS,LIKE_POST, UPLOADING_IMAGE, CLEAR_IMAGE } from '../types'
